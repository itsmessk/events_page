        ...
        <div class="program-upcoming-event">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12">
                    <?php
                    $sql = "SELECT * FROM event ORDER BY e_date ASC LIMIT 1";
                        ...
                        echo"<div class='area-content'>
                            <div class='area-top'>
                                <div class='top-section animated lightSpeedIn'>
                                    ...
                                    <span class='dates text-white text-uppercase'>" . $formatted_date . "</span>
                                </div>
                                <h2 class='heading-bold animated rollIn'>".$row["e_name"]."</h2>
                            <span class='animated fadeIn'>
                                <span class='icon map-icon'></span>
                                <span class='text-place text-white'>".$row["e_venue"]."</span>
                            </span>
                            </div>
