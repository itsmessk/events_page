...
<tr>
<tr>
<th align="left"  width="300" style="border:hidden;font-size:18px">Registration url:  </label></th>
<td width="350" style="border:hidden"><input type="text" value="" name="e_url" size="59" /></td>
<tr>
...
if(isset($_POST['addEvent']))
{
	...
	if ($EID==''||$ENAME=='' || $EDATE=='' || $ETIME==''|| $EDESC=='' || $EVENUE=='' || $EPIC == '' || $EURL=='' )
	{
		echo "<br /><p class=p1>*****Incomplete information. No Event Created.*****</p>";
	}
	else
	{
				$sql = "INSERT INTO event (e_id, e_name, e_date, e_time, e_desc, e_venue, e_pic, e_url) VALUES('$EID', '$ENAME', '$EDATE', '$ETIME', '$EDESC', '$EVENUE', '$EPIC', '$EURL')";
